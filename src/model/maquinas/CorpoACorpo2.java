...
public class CorpoACorpo2 extends Maquina {
    ...
    public CorpoACorpo2(int linha, int coluna, Jogador jogador) {
        super (5, linha, coluna, 2, 1, "Corpo A Corpo 2", 3, jogador, 1,
                0, EnumTipoMaquinas.CORPO_A_CORPO, 1, -1, -1);
    }
    ...
    public void acaoAtacar(Maquina outraMaquina, Tabuleiro tabuleiro) {
        ...
        if (pontoDeAtaque > pontoDeDefesa) {
            ...
            if ((outraMaquina.getLinha() == 0 && atavandoMemaColunaBaixo) || (outraMaquina.getLinha() == 7 && atacandoMesmaColunaCima)
                    || (outraMaquina.getColuna() == 0 && atacandoMesmaLinhaDireita) || (outraMaquina.getColuna() == 7 && atacandoMesmaLinhaEsquerda)) {
                outraMaquina.setVida(outraMaquina.getVida()-1);
