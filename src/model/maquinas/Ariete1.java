...
public class Ariete1 extends Maquina {
    
    public Ariete1(int linha, int coluna, Jogador jogador) {
        super(5, linha, coluna, 2, 1, "Ariete 1", 2, jogador, 2, -1, EnumTipoMaquinas.ARIETE, 1, 0, 0);
    }
    ...
    public String caminhoImagemDirecaoFixa() {
        return "src/images/Ariete1-Norte.png";
    }
}
