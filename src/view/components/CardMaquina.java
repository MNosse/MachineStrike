...
public class CardMaquina extends JLabel {
    ...
    private int largura = (int) (Toolkit.getDefaultToolkit().getScreenSize().getWidth() * 0.9 * 0.212);
    private int altura = (int) (largura * 1.1);
    ...
    public CardMaquina(HashMap<String, String> informacoesMaquina) {
        super(new ImageIcon(new ImageIcon("src/images/Carta.png").getImage().getScaledInstance((int) (Toolkit.getDefaultToolkit().getScreenSize().getWidth() * 0.9 * 0.212), (int) (Toolkit.getDefaultToolkit().getScreenSize().getWidth() * 0.9 * 0.212 * 1.1), Image.SCALE_SMOOTH)));
    ...
    private void initialize(String caminhoImagem, String nome, String pv, String vida, String ataque, String alcance, String movimento) {
        ...
        panCabecalho.setMinimumSize(new Dimension((int) (largura * 0.93), (int) (altura * 0.080)));
        panCabecalho.setPreferredSize(new Dimension((int) (largura * 0.93), (int) (altura * 0.080)));
        ...
        panInformacoes.setMinimumSize(new Dimension((int) (largura * 0.93), (int) (altura * 0.267)));
        panInformacoes.setPreferredSize(new Dimension((int) (largura * 0.93), (int) (altura * 0.267)));
        constraints.gridx = 0;
        ...
        constraints.gridx = 0;
        constraints.gridy = GridBagConstraints.RELATIVE;
        constraints.insets = new Insets(0, 0, (int) (altura * 0.051), 0);
        this.add(panCabecalho, constraints);
        this.add(lblImagemMaquina, constraints);
        constraints.insets = new Insets(0, 0, (int) (altura * 0.0085), 0);
